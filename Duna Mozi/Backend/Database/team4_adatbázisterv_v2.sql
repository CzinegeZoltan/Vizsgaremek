...
CREATE PROCEDURE IF NOT EXISTS vetitesFELSOROL()
  SELECT filmek.filmnev as nev,vetitesek.`vetitesdatum` as datum, vetitesek.`vetites_idvetitoterem` as terem, filmek.film_keplink as keplink, vetitesek.idvetitesek
  FROM vetitesek
  INNER JOIN filmek ON vetitesek.`vetites_idfilmek` = filmek.idfilmek
