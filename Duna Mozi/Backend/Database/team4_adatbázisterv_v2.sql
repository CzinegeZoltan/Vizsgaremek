-- Active: 1694777058782@@127.0.0.1@3306@dunamozi
...
BEGIN
  ...
  FROM
  vetitesek
  INNER JOIN ulesek ON `idVetitesek`= ulesek.`Vetites_vetitesID`
  WHERE vetitesek.`idVetitesek` = id;
END;
DELIMITER ;
...
BEGIN
  INSERT INTO vetitesek(`vetitesDATUM`,`Vetites_idVetitoTerem`,`Vetites_idfilmek`) VALUE(datum,teremid,filmid); 
END;
